  ...
  (quote
   (mapcar
    ...
    `(;; Standard font lock faces
      ...
      (font-lock-doc-face (:foreground ,faint))
      ...
      (company-tooltip-selection (:background ,background))
      ...
      (company-tooltip-annotation (:inherit company-tooltip :foregorund ,green))
      (company-tooltip-annotation-selection (:inherit company-tooltip-selection :foregorund ,green))
      ...
      (tab-line-tab-inactive (:inherit tab-line))
